...
# Creates a named tuple to use with the temperature conversions. This is done because the conversion process
#   usually isn't just a single operation. Using two dictionaries had been necessary, before introducing this
#   method, due to the conversion paradigm. The named tuple allows a normal dictionary to hold two related
...
# Meter is base unit of conversions.
length_conversions = {
    "m": 1.0,
    "mi": 0.000621371,
    "in": 39.3701,
...
# psi is base unit of conversions
...
# Should any additional units be added, the conversion number listed must be the factor to convert from the base unit to
#   the new unit. This is true for all cases, except new temperature units.
# Celsius is the basis for conversion
temp_conversions = {
...
# Joule is base unit of conversions
energy_conversions = {
    "J": 1.0,
    "gram cal": 0.239006,
    "BTU": 0.000947817,
...
# Kilogram is base unit of conversions
mass_conversions = {
    "g": 1000,
    "oz": 35.274,
    "lb": 2.20462,
...
# Determines correct conversion dictionary to use.
def converter(state):
...
def do_conversion(unit1, unit2, conversions, unit1_prefix=None, unit2_prefix=None):
    ...
    # print("unit1_conversion: ", unit1_conversion)
    # print("unit2_conversion: ", unit2_conversion)
    # print("unit1_conversion TYPE: ", type(unit1_conversion))
...
# Function that grabs the units for given value.
...
# Function that grabs the desired units.
...
# b1 = Button(top_frame, text="Distance", command=view_length_command)
